...
const CreatePostModel = ({setIsCreatePostModel}) => {
    ...
    return (
        <div className={'comment-main flex items-center justify-center bg-black/70 fixed inset-0 z-10'}>
            <div ref={commentModelRef}
                ...
                <div className="close-icon text-xl p-2 bg-white/10 hover:bg-white/20 rounded-full aspect-square cursor-pointer absolute top-0 right-0" onClick={()=>setIsCreatePostModel(false)}>
                    <AiOutlineClose/>
                </div>
